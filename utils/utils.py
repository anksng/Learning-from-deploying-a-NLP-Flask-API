...
def return_padded_data_dict(data_dict):
    ...
    padded_sequences = pad_sequence(sequences, batch_first=True, padding_value=len(word_to_ix)-1)

    padded_tags = pad_sequence(tags, batch_first=True, padding_value=len(tag_to_ix)-1)
    '''invert mapping'''
