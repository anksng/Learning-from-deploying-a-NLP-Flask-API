...
class LSTMTagger_softmax(nn.Module):
    ...
    def __init__(self, config,vocab_size, tagset_size,embedding_model):
...
class Attention_model(nn.Module):
    ...
    def __init__(self, config, tagset_size,max_length,embedding_model):
